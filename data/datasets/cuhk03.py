...
class CUHK03(BaseImageDataset):
    ...
    def __init__(self, root='/home/haoluo/data', split_id=0, cuhk03_labeled=False,
        ...
        self.raw_mat_path = osp.join(self.data_dir, 'cuhk-03.mat')  # I have this file
        ...
        # zhao yang
        self.cuhk03_labeled = cfg.CUHK03.LABELED
        self.cuhk03_classic_split = cfg.CUHK03.SPLIT

        if self.cuhk03_labeled:
            image_type = 'labeled'
            split_path = self.split_classic_lab_json_path if self.cuhk03_classic_split else self.split_new_lab_json_path
        else:
            image_type = 'detected'
            split_path = self.split_classic_det_json_path if self.cuhk03_classic_split else self.split_new_det_json_path
