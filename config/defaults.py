...
_C.CUHK03 = CN()
# CUHK03 dataset:
# labeled: CUHK03.LABELED = True or detected : CUHK03.LABELED = False
_C.CUHK03.LABELED = True
# CUHK03.SPLIT = False : new_split  or  CUHK03.SPLIT = True : classic_split
_C.CUHK03.SPLIT = False
